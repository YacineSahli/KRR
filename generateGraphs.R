...
ggplot(data.frame(x,y1,y2),aes(x))+
  ggtitle("cpu : 20% inc / yes instance / q3 (red fo, green g&t)")+
...
y1<-c(144.905, 203.318, 203.318+144.905, 203.318+2*144.905, 203.318+3*144.905)
y2<-c(41.560, 93.013, 133.081, 194.293, 194.293+(133.081-93.013))

x<-1:5
ggplot(data.frame(x,y1,y2),aes(x))+
  ggtitle("cpu : 20% inc / no instance / q3 (red fo, green g&t)")+
  xlab("entries (Million)")+
  ylab("time (sec)")+
  geom_line(aes(y=y1), colour="green")+
  geom_line(aes(y=y2), colour="red")+
...
x<-1:5
ggplot(data.frame(x,y1,y2),aes(x))+
  ggtitle("rules : 20% inc / yes instance / q3 (red fo, green g&t)")+
  xlab("entries (Million)")+
  ylab("rules")+
  geom_line(aes(y=y1), colour="green")+
  geom_line(aes(y=y2), colour="red")+
...
x<-1:5
ggplot(data.frame(x,y1,y2),aes(x))+
  ggtitle("rules : 20% inc / no instance / q3 (red fo, green g&t)")+
  xlab("entries (Million)")+
  ylab("rules")+
  geom_line(aes(y=y1), colour="green")+
  geom_line(aes(y=y2), colour="red")+
